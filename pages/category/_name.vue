...
<div>
                ...
                <div class="col-md-12">
                  <div class="hero-text">
                    <div class="ht-counter-area">
                      <p>
                        یه عددی از
                        <span class="counter-up">70</span> عدد از
                        <span class="counter-up">1036</span> شهر ها چرت و پرنت
                      </p>
                    </div>
                    <div class="ht-title">
                    ...
                    <div class="ht-rmore-btn">
                      <a class="btn-style-b">مطالب بیشتر</a>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4" v-for="post in posts" :key="post.category">
          <PostCard :post="post" />
        </div>
      </div>
    </div>
